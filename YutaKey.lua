...
Hub = {}
Hub.Title = "Yuta Hub" .. (getgenv().Premium and " [Premium]" or getgenv().Developer and " [Developer]" or " [Beta]")
Hub.Game = "BloxFruits"
...
if CurrnetExecutor == "Wave" or CurrnetExecutor == "AWP" or CurrnetExecutor == "Posstasium" then
    Notify("Yuta Hub","Your currnently executor support all function, some function will work good", 3)
else
    Notify("Yuta Hub","Your currnently executor not support all function, some function will not work", 3)
end
